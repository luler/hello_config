  ...
  [1],
  {
    ...
    '7sSR': function(e, t, n) {
      ...
      e.exports = function(e) {
        ...
        var x = m(e, 'batchProcessor', u({ reporter: b })),
          _ = {};
        ...
        var O,
          ...
          M = { reporter: b, batchProcessor: x, stateHandler: f, idHandler: t };
        if (
          ('scroll' === S &&
            (s.isLegacyOpera()
              ? (b.warn(
    ...
    KwMD: function(e, t) {
      function n(e, t, n, r) {
        var o = e.length,
          a = n + (r ? 1 : -1);
        while (r ? a-- : ++a < o) if (t(e[a], a, e)) return a;
        return -1;
      }
      e.exports = n;
    },
                ...
                var u = l,
                  f = function(c, l, s) {
                    ...
                    if (
                      ...
                      return f;
                    (b.isSetter = x), (b.isGetter = w), (b.isMethod = _), (b.isProperty = O);
                    ...
                    return (
                      (_ || O) && (delete f.value, delete f.writable),
                      (f.get = function() {
                      ...
                      (f.set = function(e) {
                        ...
                        t.set ? t.set.call(this, e) : (O || _) && (this[l] = e);
                      }),
                      f
                    );
                  };
    ...
    a1zH: function(e, t, n) {
      var r = n('y4QH'),
        ...
        y = 128,
        m = 512;
      function g(e, t, n, b, w, x, _, O, E, C) {
        var S = t & y,
          M = t & p,
          P = t & d,
          k = t & (h | v),
        ...
        function N() {
          ...
          if (k)
            var v = l(N),
              y = a(d, v);
          if ((b && (d = r(d, b, w, k)), x && (d = o(d, x, _, k)), (p -= y), k && p < C)) {
            var m = u(d, v);
    ...
    m8Tn: function(e, t, n) {
      ...
      var N = n('17x9'),
        ...
        W = T.a.oneOfType([T.a.string, T.a.object, T.a.arrayOf(T.a.object.isRequired)]),
        I = (function(e) {
          function t(t) {
            var n, r;
            return (
              ...
              D(j(j(n)), 'updateMatches', function() {
                var e = n.getMatches();
                n.setState(function() {
                  return { matches: e };
                }, n.onChange);
            ...
            (n.render = function() {
              ...
              return n
                ...
                ? 'function' === typeof t
                  ...
                  ? x.a.Children.only(t) && 'string' === typeof x.a.Children.only(t).type
                    ? x.a.Children.only(t)
                    : x.a.cloneElement(x.a.Children.only(t), { matches: r })
                  : null
                : null;
            }),
            t
      ...
      D(I, 'propTypes', {
        defaultMatches: T.a.oneOfType([T.a.bool, T.a.objectOf(T.a.bool)]),
        query: W,
        queries: T.a.objectOf(W),
        render: T.a.func,
        children: T.a.oneOfType([T.a.node, T.a.func]),
        targetWindow: T.a.object,
        onChange: T.a.func,
      });
      var K = I,
        B = n('zwU1'),
          ...
          return x.a.createElement(
            ...
            x.a.createElement(G['a'], {
              ...
              copyright: x.a.createElement(
                ...
                null,
                'Copyright ',
                x.a.createElement(Q['a'], { type: 'copyright' }),
                  ...
                  var e = this.props,
                    ...
                    r = x.a.createElement(
                      ...
                      x.a.createElement(
                        ue['a'].Item,
                        { key: 'password' },
                        x.a.createElement(Q['a'], { type: 'key' }),
                        '\u8bbe\u7f6e\u5bc6\u7801'
                      ),
                      x.a.createElement(
                        ue['a'].Item,
                        { key: 'logout' },
                        x.a.createElement(Q['a'], { type: 'logout' }),
                        x.a.createElement(ee['FormattedMessage'], {
                  ...
                  value: function() {
                    ...
                    return x.a.createElement(
                      ...
                      x.a.createElement(
                        ...
                        x.a.createElement(Q['a'], { type: t ? 'menu-unfold' : 'menu-fold' })
                      ),
                      x.a.createElement(me, this.props)
                    );
                  },
                },
              ]),
                        ...
                        x.a.createElement(
                          ...
                          x.a.createElement(
                            ...
                            x.a.createElement(
                              ae.a,
                              { to: '/' },
                              x.a.createElement('img', { src: a, alt: 'logo' }),
                              x.a.createElement('h1', null, Ce['title'])
                            )
                          ),
                          x.a.createElement(
                            'div',
      ...
      function Le() {
        return (
          (Le = Re()(
            Ne.a.mark(function e(t, n, r, a, i) {
              var c, l;
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      (n = n || 'GET'),
                        ...
                        (a = a || {}),
                        (i = void 0 === i || i),
                        (c = { method: n, headers: a, credentials: 'include' }),
                        (e.t0 = n),
                        (e.next = 'GET' === e.t0 ? 8 : 'HEAD' === e.t0 ? 9 : 10);
                      break;
                    case 8:
                                ...
                                t.json().then(function(n) {
                                  switch (t.status) {
                                    case 200:
                                      break;
                                    case 401:
                                      Object(pe['f'])(), (window.location.href = He['a'].url401);
                                      break;
                                    case 400:
                                    case 403:
                                    case 500:
      ...
      function We(e, t, n, r) {
        return (t = t || {}), (n = n || {}), (r = void 0 === r || r), ze(e, 'POST', t, n, r);
      }
      function Ie(e) {
        var t = qe();
        return function() {
                    ...
                    e.setState({ info: {} }),
                      J['a'].confirm({
                        ...
                        content: x.a.createElement(
                          'div',
                          null,
                          x.a.createElement('span', { style: { color: 'red' } }, '*'),
                          ' ',
                          x.a.createElement('span', null, '\u8bf7\u8f93\u5165\u65b0\u5bc6\u7801:'),
                          x.a.createElement(Y['a'].Password, {
                            placeholder: '\u8bf7\u8f93\u5165',
                            onChange: function(t) {
                              e.setState({
                        ...
                        cancelText: '\u53d6\u6d88',
                        onOk: function(t) {
                          We('/api/editUserInfo', o()({}, e.state.info, { type: 'password' })).then(
                            function(e) {
                  ...
                  value: function() {
                    var e = this.props,
                      ...
                      f = l
                        ...
                        : null;
                    return x.a.createElement(te['a'], { component: '', transitionName: 'fade' }, f);
                  },
                },
              ],
              [
          ...
          function n(e) {
            ...
            return (
              ...
              (r.handleOpenChange = function(e) {
                ...
                r.setState({ openKeys: t ? [e.pop()] : Xe()(e) });
              }),
              (r.state = { openKeys: Object(_e['a'])(e) }),
              r
            );
          }
          return (
                  ...
                  value: function() {
                    var e,
                      ...
                      f = M()(
                        Je.a.sider,
                        ((e = {}),
                        Ve()(e, Je.a.fixSiderBar, a),
                        Ve()(e, Je.a.light, 'light' === c),
                        e)
                      );
                    return x.a.createElement(
                      rt,
                      ...
                      x.a.createElement(
                        w['Suspense'],
                        { fallback: x.a.createElement($e['default'], null) },
                        x.a.createElement(
                          nt,
                          i()(
                            {},
        ...
        it = x.a.memo(function(e) {
          ...
          return t
            ? x.a.createElement(
                ...
                x.a.createElement(at, i()({}, e, { flatMenuKeys: a, collapsed: !t && r }))
              )
            : x.a.createElement(at, i()({}, e, { flatMenuKeys: a }));
        }),
        ct = it,
        lt = n('tGQQ'),
        st = n('W660'),
      ...
      x.a.lazy(function() {
        return Promise.all([n.e(0), n.e(13)]).then(n.bind(null, 'PceP'));
      });
      var dt = b.Content,
        ht = {
                  ...
                  var e = this,
                    ...
                    h = x.a.createElement(
                      ...
                      x.a.createElement(
                        ...
                        x.a.createElement(dt, { className: ut.a.content, style: d }, a),
                        x.a.createElement(X, null)
                      )
                    );
                  return x.a.createElement(
                    x.a.Fragment,
                    ...
                    x.a.createElement(
                      O.a,
                      { title: Object(lt['a'])(c, u) },
                      x.a.createElement(C['ContainerQuery'], { query: ht }, function(t) {
                        return x.a.createElement(
                          Ue.Provider,
                          { value: e.getContext() },
                          x.a.createElement('div', { className: M()(t) }, h)
                        );
                      })
                    ),
                    x.a.createElement(w['Suspense'], { fallback: null }, this.renderSettingDrawer())
                  );
                },
              },
            ]),
      ...
      t['default'] = Object(E['connect'])(function(e) {
        ...
        return x.a.createElement(K, { query: '(max-width: 599px)' }, function(t) {
          return x.a.createElement(vt, i()({}, e, { isMobile: t }));
        });
      });
    },
    mR0u: function(e, t, n) {
    ...
    oFg3: function(e, t, n) {
      ...
      var r = n('jehZ'),
        ...
        k = n.n(P),
        j = n('T+dw'),
        D = m['a'].createFromIconfontCN({ scriptUrl: j['iconfontUrl'] });
      function N(e) {
        var t = T();
        return function() {
          var n,
          ...
          return 'string' === typeof e
            ? Object(M['d'])(e)
              ? w.a.createElement(m['a'], {
                  component: function() {
                    return w.a.createElement('img', { src: e, alt: 'icon', className: k.a.icon });
                  },
                })
              : e.startsWith('icon-')
            ...
            u()(n, [
              {
                ...
                value: function() {
                  ...
                  var h = this.props,
                    ...
                    y = h.style,
                    m = h.menuData,
                    b = _()(l, { 'top-nav-menu': 'horizontal' === a });
                  return w.a.createElement(
                    w.a.Fragment,
                    null,
                    w.a.createElement(
        ...
        function m(e, c, s) {
          ...
          function T() {
            if ((u('finalizeDomMutation invoked.'), o(c))) {
              var e = o(c).style;
              x(c, e.width, e.height), k(c, e.width, e.height);
            } else u('Aborting because element has been uninstalled');
          }
          function A() {
            s(c);
